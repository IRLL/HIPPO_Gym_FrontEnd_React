...
class Main extends React.Component {
  state = {
    ...
    isGame: true,
    isGame: SERVER ? true : false, //if current page is the game page .. uncomment this when we want the instructions
    ...
    loadingMessages: ["Waiting for the robot to wakeup..."],
  ...
  componentDidUpdate(prevState) {
    ...
    if (
      prevState.formContent !== this.state.formContent &&
