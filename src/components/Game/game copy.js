...
//                       [2, [3], "None", [4]], 
//                       [6, "None", [7], "None", [8]]]
//     this.populateGraphValues(structure);
...
//     this.drawArrowsFromOrigin(radius);
...
//           fabric.Image.fromURL(spider, function(img){
//               var img1 = img.set({ 
//                   left: avatarNode.x, 
//                   top: avatarNode.y,
//                   originX: 'center',
...
//           if(j==1){
//               structure[0][j].push(graphValues[5]);
//           }else if(j==2){
//               structure[0][j].push(graphValues[1]);
//           }else if(j==3){
//               structure[0][j].push(graphValues[9]);
//           }
//       }

//       const recurse = (start, graphPos) =>{
//           for(var n=1; n<structure.length; n++){
//               if(structure[n][0] == start[0]){
//                   for(var j=1; j<structure[n].length; j++){
//                       if(structure[n][j] !== "None"){
//                           graphPos += 1;
//                           structure[n][j].push(graphValues[graphPos]);
//                           recurse(structure[n][j], graphPos);
//                       }
//                   }
//               }
//           }
//       }
//       for(var i=1; i<structure[0].length; i++){
//           var start = structure[0][i];
//           var graphPos = null;
//           if(i==1){
//               graphPos = 5;
//           }else if(i==2){
...
//   drawArrowsFromOrigin(radius){
//     for(var neighbor=1; neighbor<this.adjList[0].length; neighbor++){
//         var child = this.adjList[0][neighbor];
//         if(child!==null){
//             if(neighbor===1){
//                 this.drawArrow(this.cWidth/2 + radius + 5, this.cHeight/2, child.getx() - radius - 5, child.gety(), 'black');
//             }else if(neighbor===2){
//                 this.drawArrow(this.cWidth/2, this.cHeight/2 -radius- 5, child.getx(), child.gety()+radius+5, 'black');
//             }else if(neighbor===3){
//                 this.drawArrow(this.cWidth/2-radius -5, this.cHeight/2, child.getx()+radius+5, child.gety(), 'black');
//             }else if(neighbor===4){
//                 this.drawArrow(this.cWidth/2, this.cHeight/2 +radius+5, child.getx(), child.gety()- radius-5, 'black');
...
//     var values = this.graphInfo.qs[this.gameState.toString().replaceAll(",", " ")];
//     var highestVal = null;
//     var moveVal = null;
//     for(var i in values){
//         if(i == 13){
